...
class HackdaySubjectViewer extends DefaultSubjectViewer
  className: "#{DefaultSubjectViewer::className} hackday-subject-viewer"
  template: template
...
module.exports = HackdaySubjectViewer
